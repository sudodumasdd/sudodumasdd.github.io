! function(t) {
                ...
                return function t(e, r, n) {
                        ...
                        r.exports = function() {
                            ...
                            return x.prototype.toString = function() {
                                ...
                                if (e > 1) {
                                    ...
                                    for (r = 0; r < e - 1; ++r) {
                                        var o = arguments[r];
                                        if ("function" != typeof o) return x.reject(new p("Catch filter must inherit from Error or be a simple predicate function\n\n    See http://goo.gl/o84o68\n"));
                                        n[i++] = o
                                    }
                                ...
                                var r = t._fulfillmentHandlerAt(e),
                                    ...
                                    o = t._promiseAt(e),
                                    s = t._receiverAt(e);
                                o instanceof x && o._setIsMigrated(), void 0 === s && (s = c), this._addCallbacks(r, n, i, o, s, null)
                            ...
                            }, a.notEnumerableProp(x, "_makeSelfResolutionError", i), t("./progress.js")(x, g), t("./method.js")(x, h, _, s), t("./bind.js")(x, h, _), t("./finally.js")(x, d, _), t("./direct_resolve.js")(x), t("./synchronous_inspection.js")(x), t("./join.js")(x, g, _, h), x.version = "2.11.0", x.Promise = x, t("./map.js")(x, g, s, _, h), t("./cancel.js")(x), t("./using.js")(x, s, _, m), t("./generators.js")(x, s, h, _), t("./nodeify.js")(x), t("./call_get.js")(x), t("./props.js")(x, g, _, s), t("./race.js")(x, h, _, s), t("./reduce.js")(x, g, s, _, h), t("./settle.js")(x, g), t("./some.js")(x, g, s), t("./promisify.js")(x, h), t("./any.js")(x), t("./each.js")(x, h), t("./timers.js")(x, h), t("./filter.js")(x, h), a.toFastProperties(x), a.toFastProperties(x.prototype), F({
                                a: 1
                            }), F({
                                b: 2
                            }), F({
                                c: 3
                            }), F(1), F(function() {}), F(void 0), F(!1), F(new x(h)), v.setBounds(u.firstLineError, a.lastLineError), x
                        }
                    }, {
                        "./any.js": 1,
                        "./async.js": 2,
                    ...
                    38: [function(t, r, n) {
                        ...
                        var R = {
                                ...
                                isNode: void 0 !== e && "[object process]" === A(e).toLowerCase()
                            },
                            D;
                        R.isRecentNode = R.isNode && (D = e.versions.node.split(".").map(Number), 0 === D[0] && D[1] > 10 || D[0] > 0), R.isNode && R.toFastProperties(e);
                        try {
                            throw new Error
                        } catch (t) {
                            R.lastLineError = t
        ...
        (function(t, n) {
            ...
            e.format = function(t) {
                ...
                for (var n = arguments, o = n.length, s = String(t).replace(i, function(t) {
                    ...
                    }), c = n[r]; r < o; c = n[++r]) _(c) || !j(c) ? s += " " + c : s += " " + a(c);
                return s
            ...
            function a(t, r) {
                ...
                return arguments.length >= 3 && (n.depth = arguments[2]), arguments.length >= 4 && (n.colors = arguments[3]), d(r) ? n.showHidden = r : r && e._extend(n, r), y(n.showHidden) && (n.showHidden = !1), y(n.depth) && (n.depth = 2), y(n.colors) && (n.colors = !1), y(n.customInspect) && (n.customInspect = !0), n.colors && (n.stylize = c), l(n, t, n.depth)
            }
            ...
            function l(t, r, n) {
                ...
                if (t.showHidden && (s = Object.getOwnPropertyNames(r)), w(r) && (s.indexOf("message") >= 0 || s.indexOf("description") >= 0)) return p(r);
                if (0 === s.length) {
                    if (k(r)) {
                        var c = r.name ? ": " + r.name : "";
                ...
                var u, j = "",
                    E = !1,
                    x = ["{", "}"];
                (f(r) && (E = !0, x = ["[", "]"]), k(r)) && (j = " [Function" + (r.name ? ": " + r.name : "") + "]");
                return m(r) && (j = " " + RegExp.prototype.toString.call(r)), b(r) && (j = " " + Date.prototype.toUTCString.call(r)), w(r) && (j = " " + p(r)), 0 !== s.length || E && 0 != r.length ? n < 0 ? m(r) ? t.stylize(RegExp.prototype.toString.call(r), "regexp") : t.stylize("[Object]", "special") : (t.seen.push(r), u = E ? function(t, e, r, n, i) {
                    for (var o = [], s = 0, a = e.length; s < a; ++s) T(e, String(s)) ? o.push(h(t, e, r, n, String(s), !0)) : o.push("");
            ...
            function h(t, e, r, n, i, o) {
                ...
                if ((c = Object.getOwnPropertyDescriptor(e, i) || {
                        value: e[i]
                    }).get ? a = c.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : c.set && (a = t.stylize("[Setter]", "special")), T(n, i) || (s = "[" + i + "]"), a || (t.seen.indexOf(c.value) < 0 ? (a = _(r) ? l(t, c.value, null) : l(t, c.value, r - 1)).indexOf("\n") > -1 && (a = o ? a.split("\n").map(function(t) {
                        return "  " + t
                    }).join("\n").substr(2) : "\n" + a.split("\n").map(function(t) {
                        return "   " + t
            ...
            e.debuglog = function(t) {
                ...
                date: "magenta",
                regexp: "red"
            }, e.isArray = f, e.isBoolean = d, e.isNull = _, e.isNullOrUndefined = function(t) {
                return null == t
            }, e.isNumber = g, e.isString = v, e.isSymbol = function(t) {
                return "symbol" == typeof t
            }, e.isUndefined = y, e.isRegExp = m, e.isObject = j, e.isDate = b, e.isError = w, e.isFunction = k, e.isPrimitive = function(t) {
            ...
            e.log = function() {
                var t, r;
                console.log("%s - %s", (t = new Date, r = [x(t.getHours()), x(t.getMinutes()), x(t.getSeconds())].join(":"), [t.getDate(), F[t.getMonth()], r].join(" ")), e.format.apply(e, arguments))
            }, e.inherits = r(342), e._extend = function(t, e) {
                if (!e || !j(e)) return t;
    ...
    872: function(t, e, r) {
        ...
        class c {
            constructor() {
                this.healthCheck = ((t, e, r) => {
                    "youtube-content-script-status" === t.type && (this.verifyInjectionHealth(), r("ok"))
                    ...
                    "INJECTION_HEALTHY" === e.type ? this.injectionHealthy = !0 : this.port.postMessage(e)
                }), this.onPortDisconnect = (() => {
                    window.removeEventListener("GG_YT_MSG_FROM_PAGE", this.handleInjectionMessage), this.removeExistingInjection(), this.port.onMessage.removeListener(this.onPortMessage), this.port.onDisconnect.removeListener(this.onPortDisconnect), delete this.port, window.self === window.top && n.default.runtime.onMessage.removeListener(this.healthCheck)
                }), this.port = n.default.runtime.connect({
                    name: "youtube"
                }), this.port.onMessage.addListener(this.onPortMessage), this.port.onDisconnect.addListener(this.onPortDisconnect), window.addEventListener("GG_YT_MSG_FROM_PAGE", this.handleInjectionMessage), this.injectContextScript(), window.self === window.top && n.default.runtime.onMessage.addListener(this.healthCheck)
            }
            injectContextScript() {
                this.removeExistingInjection(), this.injectionHealthy = !1;
                const t = document.createElement("script");
                t.id = a, t.src = n.default.runtime.getURL("youtube_injection.js"), document.head && document.head.appendChild(t)
            }
        ...
        function u(t) {
            return new CustomEvent("GG_YT_MSG_FROM_CS", {
                detail: {
                    action: t
                }
            })
