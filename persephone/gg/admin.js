! function(t) {
        ...
        (function(t, n) {
            ...
            (function() {
                var o, s = 200,
                    ...
                    je = RegExp([he + "?" + se + "+(?:['’](?:d|ll|m|re|s|t|ve))?(?=" + [re, he, "$"].join("|") + ")", de + "+(?:['’](?:D|LL|M|RE|S|T|VE))?(?=" + [re, he + pe, "$"].join("|") + ")", he + "?" + pe + "+(?:['’](?:d|ll|m|re|s|t|ve))?", he + "+(?:['’](?:D|LL|M|RE|S|T|VE))?", "\\d*(?:(?:1ST|2ND|3RD|(?![123])\\dTH)\\b)", "\\d*(?:(?:1st|2nd|3rd|(?![123])\\dth)\\b)", ie, _e].join("|"), "g"),
                    Ee = RegExp("[\\u200d\\ud800-\\udfff" + Xt + "\\ufe0e\\ufe0f]"),
    ...
    336: function(t, e, r) {
        ...
        (function(t) {
            ...
            var f = ["oi", "ou", "st", "rs"],
                h = ["oi", "ou", "st", "rs", "sci", "api", "afi", "pfi", "x3rpi", "tsi", "tsfi"];
            ...
            function p(t) {
                ...
                try {
                    for (l.s(); !(a = l.n()).done;) {
                        var p = a.value,
                            d = t.getAll(p);
                        if (d.length > 1) throw new Error("too many values for the key: ".concat(p));
                        if (1 === d.length && "" === t.get(p)) throw new Error("empty value for the key: ".concat(p))
                    }
                } catch (t) {
                    l.e(t)
                } finally {
                ...
                var g = Number(t.get("oi"));
                if (y(g)) throw new Error(y(g));
                var v = g / E,
                    _ = t.get("ou");
                if (!b(_)) throw new Error("error parsing originalURL: ".concat(_));
                var w = t.get("st");
                s(w) || (w = e.SourceType.Unknown);
                var j = t.get("rs");
                o(j) || (j = e.Reason.Unknown);
                var A = m("sci", t, "siteCategoryID"),
                    x = m("api", t, "adminPolicyID"),
                    k = m("afi", t, "adminFilterID"),
                    R = m("pfi", t, "parentFilterID"),
                    S = m("tsi", t, "teacherSceneID"),
                    T = m("tsfi", t, "teacherSceneFilterID"),
                    P = t.get("x3rpi"),
                    O = t.getAll("tsans");
            ...
            e.createBlockUrl = function(r, n, i) {
                var a = function(t) {
                    var e = t.orgID,
                        ...
                        n = t.sourceType,
                        i = t.reason;
                    return 0 === e ? "invalid orgID" : e >= A ? "invalid orgID (too big)" : r ? s(n) ? !o(i) && "invalid reason" : "invalid sourceType" : "invalid originalURL"
                }(i);
                if (a) throw new Error("validation error: ".concat(a));
                var u = n ? "https" : "http",
                    c = r === e.Environment.Production ? w : j,
                    l = N(i.reason),
                    f = new URL("".concat(u, "://").concat(c).concat(l)),
                    h = function(e) {
                        var r = e.orgID,
                            n = e.originalURL,
                            i = e.sourceType,
                    ...
                    p = h.ctx,
                    d = h.sum;
                return f.searchParams.append(_.Ctx, p), f.searchParams.append(_.Sum, d), f
