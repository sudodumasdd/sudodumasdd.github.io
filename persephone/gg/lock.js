    ...
    */
    ...
    var x = {
        ...
        enqueueUpdate: function e(t) {
            g(), m.isBatchingUpdates ? (p.push(t), null == t._updateBatchNumber && (t._updateBatchNumber = f + 1)) : m.batchedUpdates(e, t)
        },
        ...
        asap: function(e, t) {
            l(m.isBatchingUpdates, "ReactUpdates.asap: Can't enqueue an asap callback in a context whereupdates are not being batched."), d.enqueue(e, t), h = !0
        }
    };
    e.exports = x
}, function(e, t, n) {
    ...
    l.createElement = function(e, t, n) {
        ...
        if (null != t)
            for (a in u(t) && (h = t.ref, m = o.current), c(t) && (d = "" + t.key), e.type && e.type.defaultProps && (p = e.type.defaultProps), t) i.call(t, a) && !s.hasOwnProperty(a) && (void 0 === t[a] && void 0 !== p ? f[a] = p[a] : f[a] = t[a]);
        ...
        return function(e) {
            return function(n, r, o) {
                ...
                return i = t.map(function(e) {
                    return e(u)
                }), s = f.apply(void 0, i)(a.dispatch), d({}, a, {
                    dispatch: s
                })
            }
        }
    ...
    t.DISPATCH_TYPE = "chromex.dispatch", t.STATE_TYPE = "chromex.state", t.PATCH_STATE_TYPE = "chromex.patch_state", t.DIFF_STATUS_UPDATED = "updated", t.DIFF_STATUS_REMOVED = "removed"
}, function(e, t, n) {
    e.exports = n(194)
}, function(e, t, n) {
    var r = n(35).Symbol;
    ...
    function y(e, t) {
        ...
        if (t.singleton) {
            var a = c++;
            n = u || (u = g(t)), r = A.bind(null, n, a, !1), o = A.bind(null, n, a, !0)
    ...
    var h = {
        ...
        replaceDelimitedText: function(e, t, n) {
            var r = e.parentNode,
                o = e.nextSibling;
            o === t ? n && c(r, document.createTextNode(n), o) : n ? (s(o, n), d(r, o, t)) : d(r, e, t)
        },
    ...
    function u() {
        ...
        }, o.childContextTypes = ((e = {})[t] = s.isRequired, e[n] = a, e), o
    }
    var c = u(),
        l = n(143),
        p = n.n(l),
    ...
    function A(e) {
        ...
        return function(t) {
            ...
            var n = t.displayName || t.name || "Component",
                ...
                a = function(n) {
                    function a(e, t) {
                        ...
                        return r.version = T, r.state = {}, r.renderCount = 0, r.store = e[C] || t[C], r.propsMode = Boolean(e[C]), r.setWrappedInstance = r.setWrappedInstance.bind(r), d()(r.store, 'Could not find "' + C + '" in either the context or props of "' + o + '". Either wrap the root component in a <Provider>, or explicitly pass "' + C + '" as a prop to "' + o + '".'), r.initSelector(), r.initSubscription(), r
                    }
                    return function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                        e.prototype = Object.create(t && t.prototype, {
                        ...
                        return d()(k, "To access the wrapped instance, you need to specify { withRef: true } in the options argument of the " + l + "() call."), this.wrappedInstance
                        ...
                        if (!(k || h || this.propsMode && this.subscription)) return e;
                        var t = v({}, e);
                        return k && (t.ref = this.setWrappedInstance), h && (t[h] = this.renderCount++), this.propsMode && this.subscription && (t[O] = this.subscription), t
            ...
            return a.WrappedComponent = t, a.displayName = o, a.childContextTypes = S, a.contextTypes = P, a.propTypes = P, p()(a, t)
        }
    }
    ...
    function j(e, t, n, r, o) {
        ...
        function h(o, u) {
            var h, m, g = !a(u, l),
                v = !i(o, c);
            return c = o, l = u, g && v ? (p = e(c, l), t.dependsOnOwnProps && (f = t(r, l)), d = n(p, f, l)) : g ? (e.dependsOnOwnProps && (p = e(c, l)), t.dependsOnOwnProps && (f = t(r, l)), d = n(p, f, l)) : v ? (h = e(c, l), m = !s(h, p), p = h, m && (d = n(p, f, l)), d) : d
        }
        return function(o, i) {
            return u ? h(o, i) : (p = e(c = o, l = i), f = t(r, l), d = n(p, f, l), u = !0, d)
        }
    }
    ...
    function S(e, t, n) {
        for (0, h.unmountComponent(e, n), t.nodeType === _ && (t = t.documentElement); t.lastChild;) t.removeChild(t.lastChild)
    }
    ...
    function I(e) {
        return !(!e || e.nodeType !== C && e.nodeType !== _ && e.nodeType !== k)
    }
    ...
    var D = {
        ...
        _renderSubtreeIntoContainer: function(e, t, n, o) {
            ...
            var h, g = O(n),
                ...
                b = N(n),
                x = y && !c && !b,
                C = D._renderNewRootComponent(s, n, x, i)._renderedComponent.getPublicInstance();
            return o && o.call(C), C
        },
    ...
    e.exports = function(e, t, n) {
        return null == e ? 0 : function e(t, n, l, p) {
            var f, d = typeof t;
            if ("undefined" !== d && "boolean" !== d || (t = null), null === t || "string" === d || "number" === d || "object" === d && t.$$typeof === o) return l(p, t, "" === n ? s + c(t, 0) : n), 1;
            var h = 0,
                m = "" === n ? s : n + u;
            if (Array.isArray(t))
                for (var g = 0; g < t.length; g++) h += e(f = t[g], m + c(f, g), l, p);
            else {
                var v = i(t);
                if (v) {
                    var y, b = v.call(t);
                    if (v !== t.entries)
                        for (var E = 0; !(y = b.next()).done;) h += e(f = y.value, m + c(f, E++), l, p);
                    else
                        for (; !(y = b.next()).done;) {
                            var A = y.value;
                            A && (h += e(f = A[1], m + a.escape(A[0]) + u + c(f, 0), l, p))
                        }
                } else if ("object" === d) {
                    var x = String(t);
    ...
    e.exports = function(e, t) {
        var n = i(e),
            ...
            m = h.length;
        for (var g in e) !t && !c.call(e, g) || d && ("length" == g || p && ("offset" == g || "parent" == g) || f && ("buffer" == g || "byteLength" == g || "byteOffset" == g) || s(g, m)) || h.push(g);
        return h
    }
}, function(e, t, n) {
    var r = n(158),
                ...
                if (t.name === n) {
                    var r = e.getState(),
                        i = e.subscribe(function() {
                            var n = e.getState(),
                                i = (0, a.default)(r, n);
                            i.length && (r = n, t.postMessage({
                                type: o.PATCH_STATE_TYPE,
                                payload: i
                            }))
                        });
                    t.onDisconnect.addListener(i), t.postMessage({
                        type: o.STATE_TYPE,
                        payload: r
                    })
                }
    ...
    var u = function() {
        function e(t) {
            ...
            if (function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), !r) throw new Error("portName is required in options");
            this.portName = r, this.readyResolved = !1, this.readyPromise = new Promise(function(e) {
                return n.readyResolve = e
            }), this.extensionId = u, this.port = chrome.runtime.connect(this.extensionId, {
                name: r
            }), this.listeners = [], this.state = i, this.port.onMessage.addListener(function(e) {
                switch (e.type) {
                    case s.STATE_TYPE:
                        n.replaceState(e.payload), n.readyResolved || (n.readyResolved = !0, n.readyResolve());
                        break;
        ...
        return o(e, [{
            ...
            value: function(e) {
                ...
                }), this.state = t, this.listeners.forEach(function(e) {
                    return e()
                })
            }
        }, {
            ...
            value: function(e) {
                ...
                return new Promise(function(n, r) {
                    chrome.runtime.sendMessage(t.extensionId, {
    ...
    var E = 1,
        A = {
            ...
            mountComponent: function(e, t, n, o) {
                this._context = o, this._mountOrder = E++, this._hostParent = t, this._hostContainerInfo = n;
                ...
                }(l) ? this._compositeType = m : this._compositeType = g : (a = h, b(), null === h || !1 === h || i.isValidElement(h) || r("105", l.displayName || l.name || "Component"), h = new y(l), this._compositeType = v), h.props = s, h.context = u, h.refs = f, h.updater = p, this._instance = h, c.set(h, this);
                var A, x = h.state;
                return void 0 === x && (h.state = x = null), ("object" != typeof x || Array.isArray(x)) && r("106", this.getName() || "ReactCompositeComponent"), this._pendingStateQueue = null, this._pendingReplaceState = !1, this._pendingForceUpdate = !1, A = h.unstable_handleError ? this.performInitialMountWithErrorHandling(a, t, n, e, o) : this.performInitialMount(a, t, n, e, o), h.componentDidMount && e.getReactMountReady().enqueue(h.componentDidMount, h), A
            },
            ...
            updateComponent: function(e, t, n, o, i) {
                ...
                var p = this._processPendingState(l, s),
                    f = !0;
                this._pendingForceUpdate || (a.shouldComponentUpdate ? f = a.shouldComponentUpdate(l, p, s) : this._compositeType === g && (f = !d(c, l) || !d(a.state, p))), this._updateBatchNumber = null, f ? (this._pendingForceUpdate = !1, this._performComponentUpdate(n, l, p, s, e, i)) : (this._currentElement = n, this._context = i, a.props = l, a.state = p, a.context = s)
            },
                    ...
                    for (f in t)
                        if (t.hasOwnProperty(f)) {
                            var h = (d = e && e[f]) && d._currentElement,
                                m = t[f];
                            if (null != d && i(h, m)) r.receiveComponent(d, m, s, l), t[f] = d;
                            else {
                        ...
                        } for (f in e) !e.hasOwnProperty(f) || t && t.hasOwnProperty(f) || (d = e[f], a[f] = r.getHostNode(d), r.unmountComponent(d, !1))
                }
            },
                ...
                if (s || r) {
                    ...
                    for (l in s)
                        if (s.hasOwnProperty(l)) {
                            var g = r && r[l],
                                v = s[l];
                            g === v ? (p = u(p, this.moveChild(g, m, f, d)), d = Math.max(g._mountIndex, d), g._mountIndex = f) : (g && (d = Math.max(g._mountIndex, d)), p = u(p, this._mountChildAtIndex(v, a[h], m, f, t, n)), h++), f++, m = i.getHostNode(v)
    ...
    function M(e, t) {
        t && (Y[e._tag] && (null != t.children || null != t.dangerouslySetInnerHTML) && r("137", e._tag, e._currentElement._owner ? " Check the render method of " + e._currentElement._owner.getName() + "." : ""), null != t.dangerouslySetInnerHTML && (null != t.children && r("60"), "object" == typeof t.dangerouslySetInnerHTML && S in t.dangerouslySetInnerHTML || r("61")), null != t.style && "object" != typeof t.style && r("62", function(e) {
            if (e) {
    ...
    function R(e, t, n, r) {
        if (!(r instanceof A)) {
            ...
            O(t, i), r.getReactMountReady().enqueue(j, {
                inst: e,
                registrationName: t,
                listener: n
            })
    ...
    function H() {
        ...
        switch (e || r("64"), this._tag) {
            ...
            case "video":
            case "audio":
                for (var t in this._wrapperState.listeners = [], L) L.hasOwnProperty(t) && this._wrapperState.listeners.push(d.trapBubbledEvent(t, L[t], e));
                break;
            case "source":
        ...
        mountComponent: function(e, t, n, r) {
            ...
            switch (this._tag) {
                ...
                case "video":
                    ...
                    break;
                case "input":
                    g.mountWrapper(this, p, t), p = g.getHostProps(this, p), e.getReactMountReady().enqueue(F, this), e.getReactMountReady().enqueue(H, this);
                    break;
                case "option":
                    v.mountWrapper(this, p, t), p = v.getHostProps(this, p);
                    break;
                case "select":
                    y.mountWrapper(this, p, t), p = y.getHostProps(this, p), e.getReactMountReady().enqueue(H, this);
                    break;
                case "textarea":
                    b.mountWrapper(this, p, t), p = b.getHostProps(this, p), e.getReactMountReady().enqueue(F, this), e.getReactMountReady().enqueue(H, this)
            }
            if (M(this, p), null != t ? (o = t._namespaceURI, a = t._tag) : n._tag && (o = n._namespaceURI, a = n._tag), (null == o || o === u.svg && "foreignobject" === a) && (o = u.html), o === u.html && ("svg" === this._tag ? o = u.svg : "math" === this._tag && (o = u.mathml)), this._namespaceURI = o, e.useCreateElement) {
                ...
                if (o === u.html)
                    if ("script" === this._tag) {
                        ...
                        h.innerHTML = "<" + E + "></" + E + ">", f = h.removeChild(h.firstChild)
                ...
                m.precacheNode(this, f), this._flags |= _.hasCachedChildNodes, this._hostParent || l.setAttributeForRoot(f), this._updateDOMProperties(null, p, e);
                var A = s(f);
                ...
                c = !C && W[this._tag] ? x + "/>" : x + ">" + C + "</" + this._currentElement.type + ">"
            }
            switch (this._tag) {
                case "input":
                    ...
                    break;
                case "textarea":
                    e.getReactMountReady().enqueue(B, this), p.autoFocus && e.getReactMountReady().enqueue(i.focusDOMComponent, this);
                    break;
                case "select":
                case "button":
                ...
                if (t.hasOwnProperty(r)) {
                    ...
                    if (null != i)
                        if (T.hasOwnProperty(r)) i && R(this, r, i, e);
                            ...
                            var s = null;
                            null != this._tag && G(this._tag, t) ? N.hasOwnProperty(r) || (s = l.createMarkupForCustomAttribute(r, i)) : s = l.createMarkupForProperty(r, i), s && (n += " " + s)
                        }
        ...
        _updateDOMProperties: function(e, t, n) {
            ...
            for (r in e)
                if (!t.hasOwnProperty(r) && e.hasOwnProperty(r) && null != e[r])
                    ...
                    } else T.hasOwnProperty(r) ? e[r] && k(this, r) : G(this._tag, e) ? N.hasOwnProperty(r) || l.deleteValueForAttribute(w(this), r) : (c.properties[r] || c.isCustomAttribute(r)) && l.deleteValueForProperty(w(this), r);
            for (r in t) {
                var p = t[r],
                ...
                else if (T.hasOwnProperty(r)) p ? R(this, r, p, n) : f && k(this, r);
                else if (G(this._tag, t)) N.hasOwnProperty(r) || l.setValueForAttribute(w(this), r, p);
    ...
    }, o(Z.prototype, Z.Mixin, E.Mixin), e.exports = Z
}, function(e, t, n) {
    "use strict";
    var r = n(77),
        o = n(6),
    ...
    var r = n(41),
        ...
        s = {
            ...
            extractEvents: function(e, t, n, s) {
                ...
                return g.type = "mouseenter", g.target = h, g.relatedTarget = d, r.accumulateEnterLeaveDispatches(m, g, c, l), [m, g]
            }
        };
    e.exports = s
}, function(e, t, n) {
    ...
    function T(e, t, n) {
        if ("topSelectionChange" === e || "topKeyUp" === e || "topKeyDown" === e) return A(g, n)
    }
    ...
    i.canUseDOM && (_ = p("input") && (!document.documentMode || document.documentMode > 9));
    var N = {
        eventTypes: d,
        ...
        extractEvents: function(e, t, n, r) {
            ...
            if ("select" === (u = (s = c).nodeName && s.nodeName.toLowerCase()) || "input" === u && "file" === s.type ? v ? o = x : i = C : f(c) ? _ ? o = S : (o = T, i = O) : function(e) {
                    var t = e.nodeName;
    ...
    function x(e, t, n, o) {
        ...
        if (l ? s = function(e) {
            ...
            }(e) : A ? b(e, n) && (s = v.compositionEnd) : function(e, t) {
                return "topKeyDown" === e && t.keyCode === c
            }(e, n) && (s = v.compositionStart), !s) return null;
        h && (A || s !== v.compositionStart ? s === v.compositionEnd && A && (u = A.getData()) : A = i.getPooled(o));
    ...
    e.exports = {
        inject: function() {
            x || (x = !0, v.EventEmitter.injectReactEventListener(g), v.EventPluginHub.injectEventPluginOrder(a), v.EventPluginUtils.injectComponentTree(p), v.EventPluginUtils.injectTreeTraversal(d), v.EventPluginHub.injectEventPluginsByName({
                SimpleEventPlugin: A,
                EnterLeaveEventPlugin: s,
                ChangeEventPlugin: i,
                SelectEventPlugin: E,
                BeforeInputEventPlugin: o
            }), v.HostComponent.injectGenericComponentClass(l), v.HostComponent.injectTextComponentClass(h), v.DOMProperty.injectDOMPropertyConfig(r), v.DOMProperty.injectDOMPropertyConfig(u), v.DOMProperty.injectDOMPropertyConfig(b), v.EmptyComponent.injectEmptyComponentFactory(function(e) {
                return new f(e)
            }), v.Updates.injectReconcileTransaction(y), v.Updates.injectBatchingStrategy(m), v.Component.injectEnvironment(c))
        }
    }
}, function(e, t, n) {
    "use strict";
    ...
    e.exports = function(e, t, n) {
                        ...
                        if (t)
                            for (var n in t) {
                                ...
                                if (t.hasOwnProperty(n)) {
                                    ...
                                    var a = n in e;
                                    i(!a, "ReactClass: You are attempting to define `%s` on your component more than once. This conflict may be due to a mixin.", n), e[n] = r
                                }
                            }
                    }(e, t)
                },
                    ...
                    if (n.hasOwnProperty(s) && s !== a) {
                        ...
                        if (l(f, s), c.hasOwnProperty(s)) c[s](e, p);
                            ...
                            if ("function" != typeof p || m || f || !1 === n.autobind)
                                if (f) {
                                    var g = u[s];
                                    i(m && ("DEFINE_MANY_MERGED" === g || "DEFINE_MANY" === g), "ReactClass: Unexpected spec policy %s for key %s when mixing in component specs.", g, s), "DEFINE_MANY_MERGED" === g ? r[s] = d(r[s], p) : "DEFINE_MANY" === g && (r[s] = h(r[s], p))
                                } else r[s] = p;
        ...
        return r(b.prototype, e.prototype, y),
            function(e) {
                ...
                for (var r in t.prototype = new b, t.prototype.constructor = t, t.prototype.__reactAutoBindPairs = [], s.forEach(p.bind(null, t)), p(t, g), p(t, e), p(t, v), t.getDefaultProps && (t.defaultProps = t.getDefaultProps()), i(t.prototype.render, "createClass(...): Class specification must implement a `render` method."), u) t.prototype[r] || (t.prototype[r] = null);
                return t
            }
    }
}, function(e, t, n) {
    ...
    e.exports = function(e, t) {
            ...
            p = {
                ...
                node: function() {
                    return h(function(e, t, n, r, o) {
                        if (!g(e[t])) return new d("Invalid " + r + " `" + o + "` supplied to `" + n + "`, expected a ReactNode.");
                        return null
                    })
                }(),
                objectOf: function(e) {
        ...
        function h(e) {
            function n(n, r, i, a, u, c, p) {
                (a = a || l, c = c || i, p !== s) && (t && o(!1, "Calling PropTypes validators directly is not supported by the `prop-types` package. Use `PropTypes.checkPropTypes()` to call them. Read more at http://fb.me/use-check-prop-types"));
                return null == r[i] ? n ? null === r[i] ? new d("The " + u + " `" + c + "` is marked as required in `" + a + "`, but its value is `null`.") : new d("The " + u + " `" + c + "` is marked as required in `" + a + "`, but its value is `undefined`.") : null : e(r, i, a, u, c)
            }
            var r = n.bind(null, !1);
        ...
        function m(e) {
            return h(function(t, n, r, o, i, a) {
                var s = t[n];
                return v(s) !== e ? new d("Invalid " + o + " `" + i + "` of type `" + y(s) + "` supplied to `" + r + "`, expected `" + e + "`.") : null
            })
        }
    ...
    e.exports = function(e, t) {
        ...
        return function(e, t) {
            var n, i, a, f, L, F, H, V, W, q, Y, z, K, $, G, X, Z, Q, J, ee = t.additional,
                te = t.nonTerminated,
                ne = t.text,
                re = t.reference,
                oe = t.warning,
            ...
            X = ye(), V = oe ? function(e, t) {
                var n = ye();
                n.column += t, n.offset += t, oe.call(se, B[e], n, e)
            } : p, pe--, le++;
            for (; ++pe < le;)
                if (L === h && (de = ce[fe] || 1), (L = e.charCodeAt(pe)) === v) {
                    if ((H = e.charCodeAt(pe + 1)) === d || H === h || H === m || H === g || H === v || H === b || H != H || ee && H === ee) {
                        me += l(L), de++;
                        continue
                    }
                    for (z = K = pe + 1, J = K, H === A ? (J = ++z, (H = e.charCodeAt(J)) === x || H === C ? ($ = w, J = ++z) : $ = O) : $ = k, n = "", Y = "", f = "", G = P[$], J--; ++J < le && (H = e.charCodeAt(J), G(H));) f += l(H), $ === k && c.call(r, f) && (n = f, Y = r[f]);
                    (a = e.charCodeAt(J) === y) && (J++, (i = $ === k && u(f)) && (n = f, Y = i)), Q = 1 + J - K, (a || te) && (f ? $ === k ? (a && !Y ? V(R, 1) : (n !== f && (J = z + n.length, Q = 1 + J - z, a = !1), a || (W = n ? S : I, t.attribute ? (H = e.charCodeAt(J)) === E ? (V(W, Q), Y = null) : s(H) ? Y = null : V(W, Q) : V(W, Q))), F = Y) : (a || V(N, Q), F = parseInt(f, T[$]), (ve = F) >= 55296 && ve <= 57343 || ve > 1114111 ? (V(D, Q), F = l(_)) : F in o ? (V(j, Q), F = o[F]) : (q = "", U(F) && V(j, Q), F > 65535 && (q += l((F -= 65536) >>> 10 | 55296), F = 56320 | 1023 & F), F = q + l(F))) : $ !== k && V(M, Q)), F ? (be(), X = ye(), pe = J - 1, de += J - K + 1, ge.push(F), (Z = ye()).offset++, re && re.call(ae, F, {
                        start: X,
                        end: Z
                    }, e.slice(K - 1, J)), X = Z) : (f = e.slice(K - 1, J), me += f, de += f.length, pe = J - 1)
                } else 10 === L && (he++, fe++, de = 0), L == L ? (me += l(L), de++) : be();
            var ve;
            return ge.join("");
            ...
            function be() {
                me && (ge.push(me), ne && ne.call(ie, me, {
                    start: X,
                    end: ye()
                }), me = "")
            }
    ...
    B[S] = "Named character references must be terminated by a semicolon", B[N] = "Numeric character references must be terminated by a semicolon", B[I] = "Named character references cannot be empty", B[M] = "Numeric character references cannot be empty", B[R] = "Named character references must be known", B[j] = "Numeric character references cannot be disallowed", B[D] = "Numeric character references cannot be outside the permissible Unicode range"
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(e, t, n) {
    "use strict";
    e.exports = function(e, t) {
        var n = e.indexOf("[", t),
    ...
    e.exports = function(e) {
        var t, n = 0,
            ...
            i = e.charAt(n),
            a = {};
        for (; i in r;) t = r[i], o += t, t > 1 && (o = Math.floor(o / t) * t), a[o] = n, i = e.charAt(++n);
        return {
            indent: o,
            stops: a
        }
    ...
    t.typeOf = A, t.AsyncMode = p, t.ConcurrentMode = f, t.ContextConsumer = l, t.ContextProvider = c, t.Element = o, t.ForwardRef = d, t.Fragment = a, t.Lazy = v, t.Memo = g, t.Portal = i, t.Profiler = u, t.StrictMode = s, t.Suspense = h, t.isValidElementType = function(e) {
        return "string" == typeof e || "function" == typeof e || e === a || e === f || e === u || e === s || e === h || e === m || "object" == typeof e && null !== e && (e.$$typeof === v || e.$$typeof === g || e.$$typeof === c || e.$$typeof === l || e.$$typeof === d || e.$$typeof === y || e.$$typeof === b || e.$$typeof === E)
    ...
    function s(e, t) {
        ...
        var d = function(e, t, n, i, a, c) {
            var l = {
                ...
                p = "string" == typeof i;
            n.sourcePos && e.position && (l["data-sourcepos"] = [(f = e.position).start.line, ":", f.start.column, "-", f.end.line, ":", f.end.column].map(String).join(""));
            var f;
            n.rawSourcePos && !p && (l.sourcePosition = e.position);
            n.includeNodeIndex && a.node && a.node.children && !p && (l.index = a.node.children.indexOf(e), l.parentChildCount = a.node.children.length);
            ...
            switch (e.type) {
                ...
                case "heading":
                    ...
                    break;
                case "list":
                    l.start = e.start, l.ordered = e.ordered, l.tight = !e.loose, l.depth = e.depth;
                    break;
                case "listItem":
                    l.checked = e.checked, l.tight = !e.loose, l.ordered = e.ordered, l.index = e.index, l.children = function(e, t) {
                ...
                case "tableBody":
                    ...
                    break;
                case "tableRow":
                    l.isHeader = "tableHead" === a.node.type, l.columnAlignment = a.props.columnAlignment;
                    break;
                case "tableCell":
                    u(l, {
                ...
                case "virtualHtml":
                    ...
                    break;
                case "html":
                    l.isBlock = e.position.start.line !== e.position.end.line, l.escapeHtml = n.escapeHtml, l.skipHtml = n.skipHtml;
                    break;
                case "parsedHtml":
                    var h;
                    ...
                    })), l.escapeHtml = n.escapeHtml, l.skipHtml = n.skipHtml, l.element = function(e, t) {
                        var n = e.element;
                        if (Array.isArray(n)) {
        ...
        return r.createElement(l, d, d.children || e.children && e.children.map(function(n, r) {
            return s(n, t, {
                node: e,
                props: d
            }, r)
    ...
    e.exports = function(e) {
        ...
        return r(e, "html", function(e, r, s) {
            ...
            return l ? s.children.splice(r, 0, function(e, t, n) {
    ...
    e.exports = function(e, t, n) {
        ...
        if (n) return !0;
        r = this.inlineMethods, a = r.length, o = this.inlineTokenizers, i = -1, p = t.length;
        for (; ++i < a;) "text" !== (l = r[i]) && o[l] && ((c = o[l].locator) || e.file.fail("Missing locator: `" + l + "`"), -1 !== (u = c.call(this, t, 1)) && u < p && (p = u));
        s = t.slice(0, p), f = e.now(), this.decode(s, f, function(t, n, r) {
            e(r || t)({
                type: "text",
                value: t
            })
    ...
    function a(e, t, n) {
        for (var o, a, s, u, c, l, p, f, d = t.length, h = 0, m = "", g = ""; h < d && t.charAt(h) === i;) m += i, h++;
        if (m) {
            for (c = m, u = h, m = "", f = t.charAt(h), s = 0; h < d;) {
                if (l = f, f = t.charAt(h + 1), l === i ? (s++, g += l) : (s = 0, m += l), s && f !== i) {
                    if (s === u) {
                        c += m + g, p = !0;
                        break
                    }
            ...
            if (n) return !0;
            for (o = "", a = "", d = m.length, h = -1; ++h < d;) l = m.charAt(h), r(l) ? a += l : (a && (o && (o += a), a = ""), o += l);
            return e(c)({
                type: "inlineCode",
                value: o
            })
    ...
    function s(e, t, n) {
        var o, s, u, c = "",
            ...
            p = "",
            f = "";
        if (this.options.gfm && t.charAt(0) === i && t.charAt(1) === i && !r(t.charAt(2)))
            for (o = 1, s = t.length, (u = e.now()).column += 2, u.offset += 2; ++o < s;) {
                if (!((c = t.charAt(o)) !== i || l !== i || p && r(p))) return !!n || e(a + f + a)({
                    type: "delete",
    ...
    function c(e, t, n) {
        var a, c, l, p, f, d, h, m = 0,
            g = t.charAt(m);
        if (!(g !== s && g !== u || (c = this.options.pedantic, f = g, l = g, d = t.length, m++, p = "", g = "", c && i(t.charAt(m)))))
            for (; m < d;) {
                if (h = g, !((g = t.charAt(m)) !== l || c && i(h))) {
                    if ((g = t.charAt(++m)) !== l) {
                        ...
                        return !!n || ((a = e.now()).column++, a.offset++, e(f + p + l)({
                            type: "emphasis",
    ...
    function u(e, t, n) {
        var i, u, c, l, p, f, d, h = 0,
            m = t.charAt(h);
        if (!(m !== a && m !== s || t.charAt(++h) !== m || (u = this.options.pedantic, p = (c = m) + c, f = t.length, h++, l = "", m = "", u && o(t.charAt(h)))))
            for (; h < f;) {
                if (d = m, !((m = t.charAt(h)) !== c || t.charAt(h + 1) !== c || u && o(d)) && (m = t.charAt(h + 2)) !== c) {
                    if (!r(l)) return;
                    return !!n || ((i = e.now()).column += 2, i.offset += 2, e(p + l + p)({
                        type: "strong",
    ...
    function g(e, t, n) {
        var o, g, v, y, b, E, A, x, C = t.charAt(0),
            _ = 0,
            k = t.length,
            w = "",
            O = "",
        ...
        if ("!" === C && (T = s, O = C, C = t.charAt(++_)), C === h) {
            if (_++, O += C, E = "", this.options.footnotes && t.charAt(_) === f) {
                if (T === s) return;
                O += f, _++, T = u
            }
            for (x = 0; _ < k;) {
            ...
            if (w = E, o = E, (C = t.charAt(_)) === m) {
                for (_++, w += C, E = ""; _ < k && (C = t.charAt(_), r(C));) E += C, _++;
                if (C = t.charAt(_), T !== u && C === h) {
                    for (g = "", E += C, _++; _ < k && (C = t.charAt(_)) !== h && C !== m;) C === d && (g += d, C = t.charAt(++_)), g += C, _++;
                    (C = t.charAt(_)) === m ? (P = g ? p : l, E += g + C, _++) : g = "", w += E, E = ""
                } else {
                    if (!o) return;
                    g = o
                }
                if (P === p || !A) return w = O + w, T === a && this.inLink ? null : !!n || (T === u && -1 !== o.indexOf(" ") ? e(w)({
                    type: "footnote",
                    children: this.tokenizeInline(o, e.now())
                }) : ((v = e.now()).column += O.length, v.offset += O.length, y = {
                    type: T + "Reference",
                    identifier: i(g = P === p ? g : o)
                }, T !== a && T !== s || (y.referenceType = P), T === a ? (b = this.enterLink(), y.children = this.tokenizeInline(o, v), b()) : T === s && (y.alt = this.decode.raw(this.unescape(o), v) || null), e(w)(y)))
            }
        }
    }
}, function(e, t, n) {
    ...
    function g(e, t, n) {
        var o, g, v, y, b, E, A, x, C, _, k, w, O, T, P, S, N, I, M, R = "",
            j = 0,
            D = t.charAt(0),
            B = this.options.pedantic,
            U = this.options.commonmark,
            L = this.options.gfm;
        if ("!" === D && (C = !0, R = D, D = t.charAt(++j)), D === s && (C || !this.inLink)) {
            for (R += D, P = "", j++, w = t.length, T = 0, (N = e.now()).column += j, N.offset += j; j < w;) {
                if (E = D = t.charAt(j), D === d) {
                    ...
                    if ((!v || L) && D === u) {
                        if (!T) {
                            if (!B)
                                for (; j < w && (D = t.charAt(j + 1), r(D));) E += D, j++;
            ...
            if (o) {
                for (_ = P, R += P + E, j++; j < w && (D = t.charAt(j), r(D));) R += D, j++;
                if (D = t.charAt(j), x = U ? m : h, P = "", y = R, D === p) {
                    ...
                    for (D = null, E = ""; j < w && (D = t.charAt(j), !E || !i.call(x, D));) {
                        if (r(D)) {
                            if (!B) break;
                            E += D
                        } else {
                            ...
                            P += E, E = "", D === a && (P += a, D = t.charAt(++j)), P += D
                        }
                        j++
                    }
                    S = P, j = (R += P).length
                ...
                if (D = t.charAt(j), R += P, P && i.call(x, D))
                    if (j++, R += D, P = "", k = x[D], b = R, U) {
                        for (; j < w && (D = t.charAt(j)) !== k;) D === a && (P += a, D = t.charAt(++j)), j++, P += D;
                        if ((D = t.charAt(j)) !== k) return;
                        for (O = P, R += P + D, j++; j < w && (D = t.charAt(j), r(D));) R += D, j++
                    } else
                        for (E = ""; j < w;) {
                            if ((D = t.charAt(j)) === k) A && (P += k + E, E = ""), A = !0;
                            else if (A) {
                                if (D === l) {
                                    R += P + k + E, O = P;
                                    break
                ...
                if (t.charAt(j) === l) return !!n || (R += l, S = this.decode.raw(this.unescape(S), e(y).test().end, {
                    nonTerminated: !1
                }), O && (b = e(b).test().end, O = this.decode.raw(this.unescape(O), b)), M = {
                    type: C ? "image" : "link",
                    title: O || null,
                    url: S
                }, C ? M.alt = this.decode.raw(this.unescape(_), N) || null : (I = this.enterLink(), M.children = this.tokenizeInline(_, N), I()), e(R)(M))
            }
        }
    }
    m['"'] = '"', m["'"] = "'", m[c] = l
    ...
    function u(e, t, n) {
        var o, u, c = t.length;
        if (!("<" !== t.charAt(0) || c < 3) && (o = t.charAt(1), (r(o) || "?" === o || "!" === o || "/" === o) && (u = t.match(i)))) return !!n || (u = u[0], !this.inLink && a.test(u) ? this.inLink = !0 : this.inLink && s.test(u) && (this.inLink = !1), e(u)({
            type: "html",
            value: u
        }))
    }
    ...
    function m(e, t, n) {
        ...
        if (this.options.gfm) {
            for (i = "", v = -1, A = h; ++v < A;)
                ...
                for (v = i.length, A = t.length, x = "", C = 0; v < A && (g = t.charAt(v), !o(g) && g !== l) && ("." !== g && "," !== g && ":" !== g && ";" !== g && '"' !== g && "'" !== g && ")" !== g && "]" !== g || (_ = t.charAt(v + 1)) && !o(_)) && (g !== u && g !== a || C++, g !== c && g !== s || !(--C < 0));) x += g, v++;
                if (x) {
                    if (m = i += x, b === f) {
                        if (-1 === (y = x.indexOf(p)) || y === A - 1) return;
                        m = m.substr(f.length)
                    }
                    return !!n || (k = this.enterLink(), m = this.tokenizeInline(m, e.now()), k(), e(i)({
                        type: "link",
                        title: null,
                        url: r(i, {
                            nonTerminated: !1
    ...
    function f(e, t, n) {
        ...
        if (t.charAt(0) === a) {
            for (this, i = "", f = t.length, d = 0, h = "", g = !1, v = "", d++, i = a; d < f && (m = t.charAt(d), !(r(m) || m === s || m === u || ":" === m && t.charAt(d + 1) === c));) h += m, d++;
            if (h) {
                if (v += h, h = "", v += m = t.charAt(d), d++, m === u) g = !0;
                else {
                    if (":" !== m || t.charAt(d + 1) !== c) return;
                    v += c, d++
                }
                for (; d < f && (m = t.charAt(d), !r(m) && m !== s);) h += m, d++;
                if (m = t.charAt(d), h && m === s) return !!n || (b = v += h, i += v + m, (y = e.now()).column++, y.offset++, g && (v.slice(0, p).toLowerCase() === l ? (b = b.substr(p), y.column += p, y.offset += p) : v = l + v), E = this.inlineTokenizers, this.inlineTokenizers = {
                    text: E.text
                }, A = this.enterLink(), b = this.tokenizeInline(b, y), this.inlineTokenizers = E, A(), e(i)({
                    type: "link",
                    title: null,
                    url: o(v, {
                        nonTerminated: !1
    ...
    e.exports = function(e, t, n) {
        ...
        for (; A < x;) {
            ...
            if (b.list.call(this, e, f, !0) && (this.inList || v || y && !o(r.left(f).charAt(0)))) break;
            if (p = A, -1 !== (A = t.indexOf(s, A + 1)) && "" === r(t.slice(p, A))) {
                A = p;
                break
            }
        }
        ...
        if (n) return !0;
        return m = e.now(), f = i(f), e(f)({
            type: "paragraph",
            children: this.tokenizeInline(f, m)
        })
    };
    var s = "\n",
        u = "\t",
    ...
    var r = n(199);
    e.exports = function(e, t, n) {
        var y, b, E, A, x, C, _, k, w, O, T, P, S, N, I, M, R, j, D, B, U, L, F, H;
        if (!this.options.gfm) return;
        y = 0, j = 0, C = t.length + 1, _ = [];
        for (; y < C;) {
            if (L = t.indexOf(l, y), F = t.indexOf(s, y + 1), -1 === L && (L = t.length), -1 === F || F > L) {
                if (j < d) return;
                break
            }
            _.push(t.slice(y, L)), j++, y = L + 1
        }
        A = _.join(l), b = _.splice(1, 1)[0] || [], y = 0, C = b.length, j--, E = !1, T = [];
        for (; y < C;) {
            if ((w = b.charAt(y)) === s) {
                if (O = null, !1 === E) {
                    if (!1 === H) return
        ...
        for (; ++R < j;) {
            for (D = _[R], x = {
                    type: "tableRow",
                    children: []
                }, R && e(l), e(D).reset(x, U), C = D.length + 1, y = 0, k = "", P = "", S = !0, N = null, I = null; y < C;)
                    ...
                    if ("" === w || w === s)
                        if (S) e(w);
                            ...
                            if (w && I) {
                                k += w, y++;
                                continue
                            }!P && !w || S || (A = P, k.length > 1 && (w ? (A += k.slice(0, k.length - 1), k = k.charAt(k.length - 1)) : (A += k, k = "")), M = e.now(), e(A)({
                                type: "tableCell",
                                children: this.tokenizeInline(P, M)
                            }, x)), e(k + w), k = "", P = ""
                        }
                    else if (k && (P += k, k = ""), P += w, w === o && y !== C - 2 && (P += D.charAt(y + 1), y++), w === i) {
    ...
    function y(e, t, n) {
        for (var r, v, y, A, x, C, _, k, w = this.options.commonmark, O = 0, T = t.length, P = ""; O < T && ((A = t.charAt(O)) === l || A === c);) P += A, O++;
        if ((A = t.charAt(O)) === p) {
            for (O++, P += A, y = ""; O < T && (A = t.charAt(O)) !== f;) A === s && (y += A, O++, A = t.charAt(O)), y += A, O++;
            if (y && t.charAt(O) === f && t.charAt(O + 1) === m) {
                for (C = y, O = (P += y + f + m).length, y = ""; O < T && ((A = t.charAt(O)) === c || A === l || A === u);) P += A, O++;
                ...
                if (y) {
                    for (_ = y, y = ""; O < T && ((A = t.charAt(O)) === c || A === l || A === u);) y += A, O++;
                    if (x = null, (A = t.charAt(O)) === i ? x = i : A === a ? x = a : A === d && (x = h), x) {
                        if (!y) return;
                        for (O = (P += y + A).length, y = ""; O < T && (A = t.charAt(O)) !== x;) {
                            if (A === u) {
                    ...
                    for (; O < T && ((A = t.charAt(O)) === c || A === l);) P += A, O++;
                    return (A = t.charAt(O)) && A !== u ? void 0 : !!n || (r = e(r).test().end, _ = this.decode.raw(this.unescape(_), r, {
                        nonTerminated: !1
                    }), k && (v = e(v).test().end, k = this.decode.raw(this.unescape(k), v)), e(P)({
                        type: "definition",
                        identifier: o(C),
                        title: k || null,
                        url: _
    ...
    function h(e, t, n) {
        var h, m, g, v, y, b, E, A, x, C, _, k, w = this.offset;
        if (this.options.footnotes) {
            for (h = 0, m = t.length, g = "", v = e.now(), y = v.line; h < m && (x = t.charAt(h), r(x));) g += x, h++;
            if (t.charAt(h) === c && t.charAt(h + 1) === p) {
                for (h = (g += c + p).length, E = ""; h < m && (x = t.charAt(h)) !== l;) x === i && (E += x, h++, x = t.charAt(h)), E += x, h++;
                if (E && t.charAt(h) === l && t.charAt(h + 1) === f) {
                    if (n) return !0;
                    for (C = o(E), h = (g += E + l + f).length; h < m && ((x = t.charAt(h)) === s || x === u);) g += x, h++;
                    for (v.column += g.length, v.offset += g.length, E = "", b = "", A = ""; h < m;) {
                        if ((x = t.charAt(h)) === a) {
                            for (A = x, h++; h < m && (x = t.charAt(h)) === a;) A += x, h++;
                            for (E += A, A = ""; h < m && (x = t.charAt(h)) === u;) A += x, h++;
                            if (0 === A.length) break;
                            E += A
                        }
                        E && (b += E, E = ""), b += x, h++
                    }
                    return g += b, b = b.replace(d, function(e) {
                        return w[y] = (w[y] || 0) + e.length, y++, ""
                    }), _ = e(g), k = this.enterBlock(), b = this.tokenizeBlock(b, v), k(), _({
    ...
    e.exports = function(e, t, n) {
        var u, c, l, p, f, d, h, m = this.options.blocks,
            g = t.length,
            v = 0,
            y = [
        ...
        u = -1 === (u = t.indexOf(a, v + 1)) ? g : u, c = t.slice(v, u), l = -1, f = y.length;
        for (; ++l < f;)
            if (y[l][0].test(c)) {
                d = y[l];
                break
        ...
        if (v = u, !d[1].test(c))
            for (; v < g;) {
                if (u = -1 === (u = t.indexOf(a, v + 1)) ? g : u, c = t.slice(v + 1, u), d[1].test(c)) {
                    c && (v = u);
                    break
                }
                v = u
            }
        return h = t.slice(0, v), e(h)({
            type: "html",
            value: h
        })
    };
    ...
    e.exports = function(e, t, n) {
        ...
        if (d.column += g.length, d.offset += g.length, g += u + c, l = t.charAt(++m), p = t.charAt(++m), l !== r || !s[p]) return;
        g += l, c = p, f = s[p];
        for (; ++m < h;) {
            if ((l = t.charAt(m)) !== p) {
                if (l !== r) return;
    ...
    e.exports = function(e, t) {
        ...
        for (; d--;)
            ...
            for (d = f.length; d--;) {
                ...
                p = 0 !== r(f[d]).length && h && n !== h ? u : "", f[d] = p + f[d].slice(n in l ? l[n] + 1 : 0)
            }
    ...
    var r = n(359),
        ...
        u = n(573);
    e.exports = function(e, t, n) {
        var o, a, s, m, v, y, b, E, A, w, O, T, P, S, N, I, M, R, j, D, B, U, L, F, H = this.options.commonmark,
        ...
        if (m = t.charAt(Y), o = H ? _ : C, !0 === x[m]) v = m, s = !1;
            ...
            for (s = !0, a = ""; Y < z && (m = t.charAt(Y), i(m));) a += m, Y++;
        ...
        Y = 0, S = [], N = [], I = [];
        for (; Y < z;) {
            for (y = t.indexOf(d, Y), b = Y, E = !1, F = !1, -1 === y && (y = z), L = Y + g, $ = 0; Y < z;) {
                if ((m = t.charAt(Y)) === h) $ += g - $ % g;
                else {
                    if (m !== f) break;
                    $++
            ...
            if ($ >= g && (F = !0), M && $ >= M.indent && (F = !0), m = t.charAt(Y), A = null, !F) {
                if (!0 === x[m]) A = m, Y++, $++;
                else {
                    for (a = ""; Y < z && (m = t.charAt(Y), i(m));) a += m, Y++;
                    m = t.charAt(Y), Y++, a && !0 === o[m] && (A = m, $ += a.length + 1)
                }
                if (A)
            ...
            if (A) {
                if (!V && v !== A) break;
                E = !0
            } else H || F || t.charAt(b) !== f ? H && M && (F = $ >= M.indent || $ > g) : F = !0, E = !1, Y = b;
            if (O = t.slice(b, y), w = b === Y ? O : t.slice(Y, y), (A === c || A === l || A === p) && W.thematicBreak.call(this, e, O, !0)) break;
            if (T = P, P = !r(w).length, F && M) M.value = M.value.concat(I, O), N = N.concat(I, O), I = [];
            else if (E) 0 !== I.length && (M.value.push(""), M.trail = I.concat()), M = {
                value: [O],
                indent: $,
                trail: []
            }, S.push(M), N = N.concat(I, O), I = [];
            else if (P) {
                if (T) break;
                I.push(O)
            } else {
        ...
        B = e(N.join(d)).reset({
            ...
            loose: null,
            children: []
        }), R = this.enterList(), j = this.enterBlock(), D = !1, Y = -1, z = S.length;
        for (; ++Y < z;) M = S[Y].value.join(d), U = e.now(), (M = e(M)(k(this, M, U), B)).loose && (D = !0), M = S[Y].trail.join(d), Y !== z - 1 && (M += d), e(M);
    ...
    function k(e, t, n) {
        var r, o, i = e.offset,
            a = null;
        return t = (e.options.pedantic ? w : O).apply(null, arguments), e.options.gfm && (r = t.match(y)) && (o = r[0].length, a = r[1].toLowerCase() === m, i[n.line] += o, t = t.slice(o)), {
            type: "listItem",
    ...
    function O(e, t, n) {
        var r, i, u, c, l, p, h, m = e.offset,
            g = n.line;
        for (c = (t = t.replace(b, function(e, t, n, a, s) {
                i = t + n + a, u = s, Number(n) < 10 && i.length % 2 == 1 && (n = f + n);
                return (r = t + o(f, n.length) + a) + u
            })).split(d), (l = s(t, a(r).indent).split(d))[0] = u, m[g] = (m[g] || 0) + i.length, g++, p = 0, h = c.length; ++p < h;) m[g] = (m[g] || 0) + c[p].length - l[p].length, g++;
        return l.join(d)
    }
    _["."] = !0, _[")"] = !0
}, function(e, t, n) {
    ...
    e.exports = function(e, t, n) {
        ...
        for (; ++h < m;)
            if ((l = t.charAt(h)) === p) f++, g += d + p, d = "";
                ...
                if (l !== i) return f >= c && (!l || l === r) ? (g += d, !!n || e(g)({
                    type: "thematicBreak"
                })) : void 0;
                d += l
            }
    ...
    e.exports = function(e, t, n) {
        ...
        return h.column += m.length, h.offset += m.length, e(m += g + c)({
            type: "heading",
            depth: l,
    ...
    var r = n(359),
        o = n(573);
    e.exports = function(e, t, n) {
        var c, l, p, f, d, h, m, g, v, y = this.offset,
            b = this.blockTokenizers,
        ...
        O = 0;
        for (; O < C;) {
            for (f = t.indexOf(i, O), m = O, g = !1, -1 === f && (f = C); O < C && ((l = t.charAt(O)) === s || l === a);) O++;
            if (t.charAt(O) === u ? (O++, g = !0, t.charAt(O) === s && O++) : O = m, d = t.slice(O, f), !g && !r(d)) {
                O = m;
                break
            }
            if (!g && (p = t.slice(O), o(E, b, this, [e, p, !0]))) break;
            h = m === O ? d : t.slice(m, f), w.push(O - m), _.push(h), k.push(d), O = f + 1
        }
        O = -1, C = w.length, c = e(_.join(i));
        for (; ++O < C;) y[x] = (y[x] || 0) + w[O], x++;
        return v = this.enterBlock(), k = this.tokenizeBlock(k.join(i), A), v(), c({
            type: "blockquote",
            children: k
        })
    };
    ...
    var r = n(574);
    e.exports = function(e, t, n) {
        var p, f, d, h, m, g, v, y, b, E, A, x = this.options,
            C = t.length + 1,
            _ = 0,
            k = "";
        if (!x.gfm) return;
        ...
        for (; _ < C && ((d = t.charAt(_)) === a || d === i);) k += d, _++;
        h = "", m = "";
        for (; _ < C && (d = t.charAt(_)) !== o && d !== s && d !== u;) d === a || d === i ? m += d : (h += m + d, m = ""), _++;
        if ((d = t.charAt(_)) && d !== o) return;
        if (n) return !0;
        (A = e.now()).column += k.length, A.offset += k.length, k += h, h = this.decode.raw(this.unescape(h), A), m && (k += m);
        m = "", y = "", b = "", g = "", v = "";
        for (; _ < C;)
            if (d = t.charAt(_), g += y, v += b, y = "", b = "", d === o) {
                for (g ? (y += d, b += d) : k += d, m = "", _++; _ < C && (d = t.charAt(_)) === a;) m += d, _++;
                if (y += m, b += m.slice(E), !(m.length >= l)) {
                    for (m = ""; _ < C && (d = t.charAt(_)) === f;) m += d, _++;
                    if (y += m, b += m, !(m.length < p)) {
                        for (m = ""; _ < C && ((d = t.charAt(_)) === a || d === i);) y += d, b += d, _++;
                        if (!d || d === o) break
                    }
                }
            } else g += d, b += d, _++;
    ...
    e.exports = function(e, t, n) {
        ...
        for (; ++p < f;)
            if (r = t.charAt(p), l)
                if (l = !1, d += m, h += g, m = "", g = "", r === i) m = r, g = r;
                else
                    for (d += r, h += r; ++p < f;) {
                        if (!(r = t.charAt(p)) || r === i) {
                            g = r, m = r;
                        ...
                        d += r, h += r
                    } else if (r === s && t.charAt(p + 1) === r && t.charAt(p + 2) === r && t.charAt(p + 3) === r) m += u, p += 3, l = !0;
                    else if (r === a) m += r, l = !0;
        else {
    ...
    var r = n(199);
    e.exports = function(e, t, n) {
        var o, i, a, s, u = t.charAt(0);
        if ("\n" !== u) return;
        if (n) return !0;
        s = 1, o = t.length, i = u, a = "";
        for (; s < o && (u = t.charAt(s), r(u));) a += u, "\n" === u && (i += a, a = ""), s++;
        e(i)
    }
}, function(e, t, n) {
    "use strict";
    ...
    function s(e, t, n, o) {
        ...
        function c(e, r, l) {
            var p, f = [];
            return (t && !s(e, r, l[l.length - 1] || null) || (f = u(n(e, l)))[0] !== a) && e.children && f[0] !== i && (p = u(function(e, t) {
                var n, r = o ? -1 : 1,
                    i = (o ? e.length : -1) + r;
                for (; i > -1 && i < e.length;) {
            ...
            }(e.children, l.concat(e))))[0] === a ? p : f
        }
        "function" == typeof t && "function" != typeof n && (o = n, n = t, t = null), s = r(t), c(e, null, [])
    }
    ...
    e.exports = function() {
        var e, t = String(this.file),
            ...
            s = r(n);
        65279 === (t = t.replace(a, i)).charCodeAt(0) && (t = t.slice(1), s.column++, s.offset++);
        e = {
            type: "root",
    ...
    e.exports = function(e) {
        return function(t, n) {
            ...
            for (; t;) {
                for (i = -1, a = h.length, c = !1; ++i < a && (u = h[i], !(s = m[u]) || s.onlyAtStart && !p.atStart || s.notInList && p.inList || s.notInBlock && p.inBlock || s.notInLink && p.inLink || (l = t.length, s.apply(p, [A, t]), !(c = l !== t.length))););
                c || p.file.fail(new Error("Infinite loop"), A.now())
            }
            return p.eof = b(), d;
            
            function y(e) {
                for (var t = -1, n = e.indexOf("\n"); - 1 !== n;) g++, t = n, n = e.indexOf("\n", n + 1); - 1 === t ? v += e.length : v = e.length - t, g in f && (-1 !== t ? v += f[g] : v <= f[g] && (v = f[g] + 1))
            }
            ...
            function A(e) {
                var n = function() {
                    ...
                    a = b();
                return function(e) {
                    t.substring(0, e.length) !== e && p.file.fail(new Error("Incorrectly eaten value: please report this warning on http://git.io/vg5Ft"), b())
                }(e), s.reset = u, u.test = c, s.test = c, t = t.substring(e.length), y(e), n = n(), s;
                
                function s(e, t) {
                    return i(function(e, t) {
                        var n = t ? t.children : d,
                            i = n[n.length - 1];
                        i && e.type === i.type && e.type in r && o(i) && o(e) && (e = r[e.type].call(p, i, e));
                        e !== i && n.push(e);
    ...
    e.exports = function(e) {
        var t, n = "&" + e + ";";
        if ((r = r || document.createElement("i")).innerHTML = n, (t = r.textContent).charCodeAt(t.length - 1) === o && "semi" !== e) return !1;
        return t !== n && t
    }
}, function(e, t, n) {
    "use strict";
    ...
    l.setOptions = n(1064), l.parse = n(1061), l.options = n(713), l.exitStart = o("atStart", !0), l.enterList = o("inList", !1), l.enterLink = o("inLink", !1), l.enterBlock = o("inBlock", !1), l.interruptParagraph = [
        ["thematicBreak"],
        ["atxHeading"],
        ["fencedCode"],
        ["blockquote"],
        ...
        break: n(1025),
        text: n(1023)
    }, l.blockMethods = p(l.blockTokenizers), l.inlineMethods = p(l.inlineTokenizers), l.tokenizeBlock = u("block"), l.tokenizeInline = u("inline"), l.tokenizeFactory = u
}, function(e, t, n) {
    "use strict";
    var r = n(313),
        o = n(24);
            ...
            t = {
                run: function() {
                    ...
                    (function a(s) {
                        ...
                        for (; ++f < p;) null !== l[f] && void 0 !== l[f] || (l[f] = n[f]);
                        n = l;
    ...
    (function(t) {
        ...
        function c(e) {
            ...
            for (this.data = {}, this.messages = [], this.history = [], this.cwd = t.cwd(), r = -1, o = u.length; ++r < o;) n = u[r], a.call(e, n) && (this[n] = e[n]);
        ...
        Object.defineProperty(s, "path", {
            ...
            set: function(e) {
                p(e, "basename"), l(e, "basename"), this.path = r.join(this.dirname || "", e)
            }
            ...
            set: function(e) {
                p(e, "stem"), l(e, "stem"), this.path = r.join(this.dirname || "", e + (this.extname || ""))
            }
        })
    }).call(this, n(18))
}, function(e, t, n) {
    ...
    e.exports = function e() {
        var t, n, r, o, s, u, c = arguments[0],
            ...
            p = arguments.length,
            f = !1;
        for ("boolean" == typeof c && (f = c, c = arguments[1] || {}, l = 2), (null == c || "object" != typeof c && "function" != typeof c) && (c = {}); l < p; ++l)
            if (null != (t = arguments[l]))
                for (n in t) r = c[n], c !== (o = t[n]) && (f && o && (a(o) || (s = i(o))) ? (s ? (s = !1, u = r && i(r) ? r : []) : u = r && a(r) ? r : {}, c[n] = e(f, u, o)) : void 0 !== o && (c[n] = o));
        return c
    }
}, function(e, t, n) {
    "use strict";
    ...
    e.exports = function e() {
        ...
        var E = -1;
        A.data = function(e, t) {
            if (s(e)) return 2 === arguments.length ? (m("data", b), y[e] = t, A) : l.call(y, e) && y[e] || null;
        ...
        A.use = function(e) {
            ...
            function s(e, n) {
                ...
                o ? (u(o[1]) && u(n) && (n = r(o[1], n)), o[1] = n) : t.push(c.call(arguments))
            }
        };
        A.parse = function(e) {
            var t, n = i(e);
            if (x(), d("parse", t = A.Parser), f(t)) return new t(String(n), n).parse();
            return t(String(n), n)
        };
        A.stringify = function(e, t) {
            var n, r = i(t);
            if (x(), h("stringify", n = A.Compiler), g(e), f(n)) return new n(e, r).compile();
            return n(e, r)
        };
        A.run = C;
        ...
        A.processSync = function(e) {
            var t, n = !1;
            return x(), d("processSync", A.Parser), h("processSync", A.Compiler), _(t = i(e), function(e) {
                n = !0, o(e)
        ...
        function x() {
            var e, r, o, i;
            if (b) return A;
            for (; ++E < t.length;) e = t[E], r = e[0], o = e[1], i = null, !1 !== o && (!0 === o && (e[1] = void 0), "function" == typeof(i = r.apply(A, e.slice(1))) && n.use(i));
            return b = !0, E = 1 / 0, A
        }
        
        function C(e, t, r) {
            if (g(e), x(), r || "function" != typeof t || (r = t, t = null), !r) return new Promise(o);
    ...
    const u = (new Date).toLocaleTimeString().replace(/:\d\d /, " ").toLowerCase();
    t.default = (0, o.connect)(e => {
        let t = void 0;
        return Object.keys(e).length > 0 && (t = e.teacher.state.locked.lockMessage), {
            message: t
        }
    }, null)(({
        message: e
    ...
    }, "Browsing disabled"), r.default.createElement("div", {
    ...
    }, u), e && r.default.createElement("div", {
        className: i.default["gg-lock-message-intro-teacher"]
    }, "Message from your teacher")), e && r.default.createElement("div", {
        ...
        className: i.default["gg-lock-logo"]
    }))), e.exports = t.default
}, function(e, t, n) {
    "use strict";
    var r = u(n(13)),
    ...
    (0, o.render)(r.default.createElement(i.Provider, {
        store: c
    }, r.default.createElement(s.default, null)), document.getElementById("root"))
}]);