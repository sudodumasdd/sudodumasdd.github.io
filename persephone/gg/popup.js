    ...
    */
    ...
    function _(e) {
        ...
        for (var n = 0; n < t; n++) {
            ...
            if (u.performUpdateIfNecessary(i, e.reconcileTransaction, d), o && console.timeEnd(o), a)
    ...
    var v = function(e) {
        return null == e ? void 0 === e ? h : f : m && m in Object(e) ? l(e) : d(e)
    };
    var g = function(e, t) {
        return function(n) {
            return e(t(n))
    ...
    l.createElement = function(e, t, n) {
        var r, a = {},
            ...
            d = null;
        if (null != t)
            for (r in u(t) && (d = t.ref), c(t) && (p = "" + t.key), void 0 === t.__self ? null : t.__self, void 0 === t.__source ? null : t.__source, t) i.call(t, r) && !s.hasOwnProperty(r) && (a[r] = t[r]);
        ...
        if (null != t)
            for (a in u(t) && (h = t.ref, m = o.current), c(t) && (f = "" + t.key), e.type && e.type.defaultProps && (p = e.type.defaultProps), t) i.call(t, a) && !s.hasOwnProperty(a) && (void 0 === t[a] && void 0 !== p ? d[a] = p[a] : d[a] = t[a]);
        ...
        return function(e) {
            return function(n, r, o) {
                ...
                return i = t.map(function(e) {
                    return e(u)
                }), s = d.apply(void 0, i)(a.dispatch), f({}, a, {
                    dispatch: s
                })
            }
        }
    ...
    function y(e, t) {
        ...
        if (t.singleton) {
            var a = c++;
            n = u || (u = v(t)), r = C.bind(null, n, a, !1), o = C.bind(null, n, a, !0)
    ...
    var h = {
        ...
        replaceDelimitedText: function(e, t, n) {
            var r = e.parentNode,
                o = e.nextSibling;
            o === t ? n && c(r, document.createTextNode(n), o) : n ? (s(o, n), f(r, o, t)) : f(r, e, t)
        },
    ...
    function C(e) {
        ...
        return function(t) {
            ...
            var n = t.displayName || t.name || "Component",
                ...
                a = function(n) {
                    ...
                    return function(e, t) {
                        ...
                        return f()(T, "To access the wrapped instance, you need to specify { withRef: true } in the options argument of the " + l + "() call."), this.wrappedInstance
                        ...
                        var t = g({}, e);
                        return T && (t.ref = this.setWrappedInstance), h && (t[h] = this.renderCount++), this.propsMode && this.subscription && (t[k] = this.subscription), t
            ...
            return a.WrappedComponent = t, a.displayName = o, a.childContextTypes = O, a.contextTypes = A, a.propTypes = A, p()(a, t)
        }
    }
    ...
    function D(e, t, n, r, o) {
        ...
        function h(o, u) {
            var h, m, v = !a(u, l),
                g = !i(o, c);
            return c = o, l = u, v && g ? (p = e(c, l), t.dependsOnOwnProps && (d = t(r, l)), f = n(p, d, l)) : v ? (e.dependsOnOwnProps && (p = e(c, l)), t.dependsOnOwnProps && (d = t(r, l)), f = n(p, d, l)) : g ? (h = e(c, l), m = !s(h, p), p = h, m && (f = n(p, d, l)), f) : f
        }
        return function(o, i) {
            return u ? h(o, i) : (p = e(c = o, l = i), d = t(r, l), f = n(p, d, l), u = !0, f)
        }
    }
    ...
    var j = {
        ...
        renderSubtreeIntoContainer: function(e, t, n, o) {
            return null != e && d.has(e) || r("38"), j._renderSubtreeIntoContainer(e, t, n, o)
        },
        _renderSubtreeIntoContainer: function(e, t, n, o) {
            ...
            var h, v = k(n),
                ...
                b = N(n),
                E = y && !c && !b,
                x = j._renderNewRootComponent(s, n, E, i)._renderedComponent.getPublicInstance();
            return o && o.call(x), x
        },
    ...
    e.exports = function(e, t, n) {
        return null == e ? 0 : function e(t, n, l, p) {
            var d, f = typeof t;
            if ("undefined" !== f && "boolean" !== f || (t = null), null === t || "string" === f || "number" === f || "object" === f && t.$$typeof === o) return l(p, t, "" === n ? s + c(t, 0) : n), 1;
            var h = 0,
                m = "" === n ? s : n + u;
            if (Array.isArray(t))
                for (var v = 0; v < t.length; v++) h += e(d = t[v], m + c(d, v), l, p);
            else {
                var g = i(t);
                if (g) {
                    var y, b = g.call(t);
                    if (g !== t.entries)
                        for (var _ = 0; !(y = b.next()).done;) h += e(d = y.value, m + c(d, _++), l, p);
                    else
                        for (; !(y = b.next()).done;) {
                            var C = y.value;
                            C && (h += e(d = C[1], m + a.escape(C[0]) + u + c(d, 0), l, p))
                        }
                } else if ("object" === f) {
                    var E = String(t);
    ...
    e.exports = function(e, t) {
        var n = i(e),
            ...
            m = h.length;
        for (var v in e) !t && !c.call(e, v) || f && ("length" == v || p && ("offset" == v || "parent" == v) || d && ("buffer" == v || "byteLength" == v || "byteOffset" == v) || s(v, m)) || h.push(v);
        return h
    }
}, function(e, t, n) {
    var r = n(158),
    ...
    var _ = 1,
        C = {
            ...
            mountComponent: function(e, t, n, o) {
                ...
                }(l) ? this._compositeType = m : this._compositeType = v : (a = h, b(), null === h || !1 === h || i.isValidElement(h) || r("105", l.displayName || l.name || "Component"), h = new y(l), this._compositeType = g), h.props = s, h.context = u, h.refs = d, h.updater = p, this._instance = h, c.set(h, this);
                var C, E = h.state;
                return void 0 === E && (h.state = E = null), ("object" != typeof E || Array.isArray(E)) && r("106", this.getName() || "ReactCompositeComponent"), this._pendingStateQueue = null, this._pendingReplaceState = !1, this._pendingForceUpdate = !1, C = h.unstable_handleError ? this.performInitialMountWithErrorHandling(a, t, n, e, o) : this.performInitialMount(a, t, n, e, o), h.componentDidMount && e.getReactMountReady().enqueue(h.componentDidMount, h), C
            },
            ...
            updateComponent: function(e, t, n, o, i) {
                ...
                var p = this._processPendingState(l, s),
                    d = !0;
                this._pendingForceUpdate || (a.shouldComponentUpdate ? d = a.shouldComponentUpdate(l, p, s) : this._compositeType === v && (d = !f(c, l) || !f(a.state, p))), this._updateBatchNumber = null, d ? (this._pendingForceUpdate = !1, this._performComponentUpdate(n, l, p, s, e, i)) : (this._currentElement = n, this._context = i, a.props = l, a.state = p, a.context = s)
            },
                    ...
                    for (d in t)
                        if (t.hasOwnProperty(d)) {
                            var h = (f = e && e[d]) && f._currentElement,
                                m = t[d];
                            if (null != f && i(h, m)) r.receiveComponent(f, m, s, l), t[d] = f;
                            else {
                        ...
                        } for (d in e) !e.hasOwnProperty(d) || t && t.hasOwnProperty(d) || (f = e[d], a[d] = r.getHostNode(f), r.unmountComponent(f, !1))
                }
            },
                ...
                if (s || r) {
                    ...
                    for (l in s)
                        if (s.hasOwnProperty(l)) {
                            var v = r && r[l],
                                g = s[l];
                            v === g ? (p = u(p, this.moveChild(v, m, d, f)), f = Math.max(v._mountIndex, f), v._mountIndex = d) : (v && (f = Math.max(v._mountIndex, f)), p = u(p, this._mountChildAtIndex(g, a[h], m, d, t, n)), h++), d++, m = i.getHostNode(g)
    ...
    function I(e, t) {
        t && (K[e._tag] && (null != t.children || null != t.dangerouslySetInnerHTML) && r("137", e._tag, e._currentElement._owner ? " Check the render method of " + e._currentElement._owner.getName() + "." : ""), null != t.dangerouslySetInnerHTML && (null != t.children && r("60"), "object" == typeof t.dangerouslySetInnerHTML && O in t.dangerouslySetInnerHTML || r("61")), null != t.style && "object" != typeof t.style && r("62", function(e) {
            if (e) {
    ...
    function R(e, t, n, r) {
        if (!(r instanceof C)) {
            ...
            k(t, i), r.getReactMountReady().enqueue(D, {
                inst: e,
                registrationName: t,
                listener: n
            })
        ...
        mountComponent: function(e, t, n, r) {
            ...
            switch (this._tag) {
                ...
                case "video":
                    ...
                    break;
                case "input":
                    v.mountWrapper(this, p, t), p = v.getHostProps(this, p), e.getReactMountReady().enqueue(B, this), e.getReactMountReady().enqueue(V, this);
                    break;
                case "option":
                    g.mountWrapper(this, p, t), p = g.getHostProps(this, p);
                    break;
                case "select":
                    y.mountWrapper(this, p, t), p = y.getHostProps(this, p), e.getReactMountReady().enqueue(V, this);
                    break;
                case "textarea":
                    b.mountWrapper(this, p, t), p = b.getHostProps(this, p), e.getReactMountReady().enqueue(B, this), e.getReactMountReady().enqueue(V, this)
            }
            if (I(this, p), null != t ? (o = t._namespaceURI, a = t._tag) : n._tag && (o = n._namespaceURI, a = n._tag), (null == o || o === u.svg && "foreignobject" === a) && (o = u.html), o === u.html && ("svg" === this._tag ? o = u.svg : "math" === this._tag && (o = u.mathml)), this._namespaceURI = o, e.useCreateElement) {
                ...
                if (o === u.html)
                    if ("script" === this._tag) {
                        ...
                        h.innerHTML = "<" + _ + "></" + _ + ">", d = h.removeChild(h.firstChild)
                ...
                m.precacheNode(this, d), this._flags |= w.hasCachedChildNodes, this._hostParent || l.setAttributeForRoot(d), this._updateDOMProperties(null, p, e);
                var C = s(d);
            ...
            switch (this._tag) {
                case "input":
                    e.getReactMountReady().enqueue(j, this), p.autoFocus && e.getReactMountReady().enqueue(i.focusDOMComponent, this);
                    break;
                case "textarea":
                    e.getReactMountReady().enqueue(U, this), p.autoFocus && e.getReactMountReady().enqueue(i.focusDOMComponent, this);
                    break;
                case "select":
                case "button":
                ...
                if (t.hasOwnProperty(r)) {
                    ...
                    if (null != i)
                        if (S.hasOwnProperty(r)) i && R(this, r, i, e);
                            ...
                            var s = null;
                            null != this._tag && X(this._tag, t) ? N.hasOwnProperty(r) || (s = l.createMarkupForCustomAttribute(r, i)) : s = l.createMarkupForProperty(r, i), s && (n += " " + s)
                        }
        ...
        _updateDOMProperties: function(e, t, n) {
            ...
            for (r in e)
                if (!t.hasOwnProperty(r) && e.hasOwnProperty(r) && null != e[r])
                    ...
                    } else S.hasOwnProperty(r) ? e[r] && T(this, r) : X(this._tag, e) ? N.hasOwnProperty(r) || l.deleteValueForAttribute(P(this), r) : (c.properties[r] || c.isCustomAttribute(r)) && l.deleteValueForProperty(P(this), r);
            for (r in t) {
                var p = t[r],
                ...
                else if (S.hasOwnProperty(r)) p ? R(this, r, p, n) : d && T(this, r);
                else if (X(this._tag, t)) N.hasOwnProperty(r) || l.setValueForAttribute(P(this), r, p);
    ...
    }, o(Q.prototype, Q.Mixin, _.Mixin), e.exports = Q
}, function(e, t, n) {
    "use strict";
    var r = n(77),
        o = n(6),
    ...
    var r = n(41),
        ...
        s = {
            ...
            extractEvents: function(e, t, n, s) {
                ...
                return v.type = "mouseenter", v.target = h, v.relatedTarget = f, r.accumulateEnterLeaveDispatches(m, v, c, l), [m, v]
            }
        };
    e.exports = s
}, function(e, t, n) {
    ...
    var N = {
        ...
        extractEvents: function(e, t, n, r) {
            ...
            if ("select" === (u = (s = c).nodeName && s.nodeName.toLowerCase()) || "input" === u && "file" === s.type ? g ? o = E : i = x : d(c) ? w ? o = O : (o = S, i = k) : function(e) {
                    var t = e.nodeName;
    ...
    var d, f = o.canUseDOM && "TextEvent" in window && !p && !("object" == typeof(d = window.opera) && "function" == typeof d.version && parseInt(d.version(), 10) <= 12),
    ...
    function E(e, t, n, o) {
        ...
        if (l ? s = function(e) {
            ...
            }(e) : C ? b(e, n) && (s = g.compositionEnd) : function(e, t) {
                return "topKeyDown" === e && t.keyCode === c
            }(e, n) && (s = g.compositionStart), !s) return null;
        h && (C || s !== g.compositionStart ? s === g.compositionEnd && C && (u = C.getData()) : C = i.getPooled(o));
    ...
    e.exports = function(e, t, n) {
                    ...
                    if (n.hasOwnProperty(s) && s !== a) {
                        ...
                        if (l(d, s), c.hasOwnProperty(s)) c[s](e, p);
                            ...
                            if ("function" != typeof p || m || d || !1 === n.autobind)
                                if (d) {
                                    var v = u[s];
                                    i(m && ("DEFINE_MANY_MERGED" === v || "DEFINE_MANY" === v), "ReactClass: Unexpected spec policy %s for key %s when mixing in component specs.", v, s), "DEFINE_MANY_MERGED" === v ? r[s] = f(r[s], p) : "DEFINE_MANY" === v && (r[s] = h(r[s], p))
                                } else r[s] = p;
        ...
        return r(b.prototype, e.prototype, y),
            function(e) {
                ...
                for (var r in t.prototype = new b, t.prototype.constructor = t, t.prototype.__reactAutoBindPairs = [], s.forEach(p.bind(null, t)), p(t, v), p(t, e), p(t, g), t.getDefaultProps && (t.defaultProps = t.getDefaultProps()), i(t.prototype.render, "createClass(...): Class specification must implement a `render` method."), u) t.prototype[r] || (t.prototype[r] = null);
                return t
            }
    }
}, function(e, t, n) {
    ...
    e.exports = function(e, t) {
            ...
            p = {
                ...
                arrayOf: function(e) {
                    return h(function(t, n, r, o, i) {
                        ...
                        if (!Array.isArray(a)) {
                            var u = g(a);
                            return new f("Invalid " + o + " `" + i + "` of type `" + u + "` supplied to `" + r + "`, expected an array.")
                        }
                ...
                node: function() {
                    return h(function(e, t, n, r, o) {
                        if (!v(e[t])) return new f("Invalid " + r + " `" + o + "` supplied to `" + n + "`, expected a ReactNode.");
                        return null
                    })
                }(),
                objectOf: function(e) {
        ...
        function h(e) {
            function n(n, r, i, a, u, c, p) {
                ...
                return null == r[i] ? n ? null === r[i] ? new f("The " + u + " `" + c + "` is marked as required in `" + a + "`, but its value is `null`.") : new f("The " + u + " `" + c + "` is marked as required in `" + a + "`, but its value is `undefined`.") : null : e(r, i, a, u, c)
            }
            var r = n.bind(null, !1);
        ...
        function m(e) {
            return h(function(t, n, r, o, i, a) {
                var s = t[n];
                return g(s) !== e ? new f("Invalid " + o + " `" + i + "` of type `" + y(s) + "` supplied to `" + r + "`, expected `" + e + "`.") : null
            })
        }
        ...
        return f.prototype = Error.prototype, p.checkPropTypes = u, p.PropTypes = p, p
    }
}, function(e, t, n) {
    "use strict";
    ...
    }, "You're in ", e && e.length, " Active GoGuardian Session", e && e.length > 1 && "s", ":"), r.default.createElement("div", {
        className: i.default.listContainer
    }, e && e.map(e => r.default.createElement("div", {
        key: e.id
    }, r.default.createElement("div", {
        className: i.default.classroomName
    }, "📚 Classroom: ", e.classroomName), r.default.createElement("ul", {
        className: i.default.classroomDetails
    }, r.default.createElement("li", null, "Teacher:", " ", Object.values(e.admins).find(({
        role: e
    }) => "owner" === e).name), t.lessonPlan && t.sessionId === e.id && r.default.createElement("li", null, "Some websites are restricted"))))))), e.exports = t.default
}, function(e, t, n) {
    "use strict";
    var r = u(n(13)),
        o = n(151),
    ...
    const c = new a.Store({
        ...
        l = c.subscribe(() => {
            ...
            (0, o.render)(r.default.createElement(i.Provider, {
                store: c
            }, r.default.createElement(s.default, null)), e)
        })
}]);